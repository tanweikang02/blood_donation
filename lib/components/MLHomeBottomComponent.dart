  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Row(
          children: [
            Text("Blood in Urgent Need", style: boldTextStyle(size: 18)).expand(),
            GestureDetector(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                                (bloodRequestList[index].date!.day.toString()).validate(),
                      ...
                      Row(
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                  (bloodRequestList[index].location).validate(),
                                  style: boldTextStyle()),
                              8.height,
                              Text(bloodRequestList[index].bloodTypeNeeded!.join(", ").validate(),
                                  style: secondaryTextStyle()),
                              12.height,
                              Container(
                                child: Text(bloodRequestList[index].text.validate(),
