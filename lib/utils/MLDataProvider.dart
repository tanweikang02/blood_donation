...
List<MLInboxData> mlInboxChatDataList() {
  ...
  list.add(MLInboxData(id: 0, parts: 'i have already taken medicine'));
  list.add(
      MLInboxData(id: 1, parts: 'Hi Kaixa, have you taken your pills yet?'));
  list.add(
      MLInboxData(id: 1, parts: 'sorry but i can\'t find your home number'));
  list.add(MLInboxData(id: 0, parts: 'Please knock on dor'));
  list.add(MLInboxData(id: 0, parts: 'I am home waiting for you'));
  list.add(MLInboxData(id: 0, parts: 'Hi Miranda'));
  list.add(MLInboxData(id: 1, parts: 'I am on my way to your home visit'));
  return list;
}
...
List<MLInboxData> mlBotChatDataList() {
  ...
  list.add(MLInboxData(id: 0, parts: 'yes'));
  list.add(MLInboxData(
      id: 1,
      parts: 'Hi Kaixa, Thank you for using Medilab\'s consulting service.'
          'what are you intrested in our comprehensice checkup package?'));
  list.add(MLInboxData(id: 0, parts: 'Get Started'));
