...
List<BloodRequest> bloodRequestDataList() {
  List<BloodRequest> list = [];
  list.add(BloodRequest(text: 'Please help out!', location: 'Subang Jaya Medical Centre', date: DateTime.now(), bloodTypeNeeded: ["A-", "O-"], recipientName: 'John Doe'));
  list.add(BloodRequest(text: 'Please help out!', location: 'Subang Jaya Medical Centre', date: DateTime.now(), bloodTypeNeeded: ["A-", "O-"], recipientName: 'John Doe'));
  list.add(BloodRequest(text: 'Please help out!', location: 'Subang Jaya Medical Centre', date: DateTime.now(), bloodTypeNeeded: ["A-", "O-"], recipientName: 'John Doe'));
  list.add(BloodRequest(text: 'Please help out!', location: 'Subang Jaya Medical Centre', date: DateTime.now(), bloodTypeNeeded: ["A-", "O-"], recipientName: 'John Doe'));
  list.add(BloodRequest(text: 'Please help out!', location: 'Subang Jaya Medical Centre', date: DateTime.now(), bloodTypeNeeded: ["A-", "O-"], recipientName: 'John Doe'));
