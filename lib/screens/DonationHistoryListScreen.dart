...
class _DonationHistoryListScreenState extends State<DonationHistoryListScreen> {
  List<DonationRecord> records = [
    DonationRecord(donorName: "Chai Waii Yuan", location: "Subang Jaya Medical Centre", bloodVolume_Milliliter: 450, donationDateTime: DateTime.now(), entryDateTime: DateTime.now()),
    DonationRecord(donorName: "Chai Waii Yuan", location: "Subang Jaya Medical Centre", bloodVolume_Milliliter: 350, isVoluntary: false, paymentAmount: 18.80, donationDateTime: DateTime.now(), entryDateTime: DateTime.now())
  ];
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text((e.donationDateTime?.day.toString()).validate(),
                                              style: boldTextStyle(
                                                  size: 32, color: white)),
                                          Text("${e.donationDateTime?.month.toMonthName(isHalfName: true)} ${e.donationDateTime?.year}".validate(),
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text((e.donorName).validate(),
                                                style: secondaryTextStyle()),
                                            8.height,
                                            Text((e.donationDateTime?.toReadableFormat()).validate(),
                                                style: secondaryTextStyle()),
                                          ],
                                        ).expand(),
                                      ],
                                ...
                                Row(
                                  children: [
                                    Text("${e.bloodVolume_Milliliter.toString()} ml".validate(),
                                        style: boldTextStyle(
                                            color: mlPrimaryColor)),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.end,
                                      children: [
                                        Text("Payment: RM ${e.paymentAmount!.toStringAsFixed(2)}",
                                            style: secondaryTextStyle(
                                                color: mlPrimaryColor)),
                                      ],
                                    ).expand()
